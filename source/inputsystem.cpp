...
{
	// Clean up previously allocated controllers if needed
	if (m_pXboxController)
	{
		delete[] m_pXboxController;
		m_pXboxController = nullptr;
	...
	// Handle case with no controllers attached
	if (m_iNumAttachedControllers > 0)
	{
	...
	{
		m_pXboxController = nullptr; // No controllers attached
	}
